...
| 下游 tag / peeled commit | `v3.0.0.znmlr.1` / `726d79fe7925aa8ffdaec0c7ec84b5a4e58159c1` |
| tag CI | [run 33362303670](https://github.com/yangyunzhao/Eta/actions/runs/33362303670)，完整单元测试、Lint、签名构建和 APK 校验均通过。 |
| GitHub Release | [v3.0.0.znmlr.1](https://github.com/yangyunzhao/Eta/releases/tag/v3.0.0.znmlr.1) |
...
| 本地签名候选 APK | `release/Eta-v3.0.0.znmlr.1-release.apk`，`fuck.andes`，`3.0.0.znmlr.1` / `2026083101`，APK Signature Scheme v2，证书 SHA-256 `44:4D:EB:65:E1:19:AE:74:38:6D:76:D2:16:FC:EE:70:62:B8:A9:0C:68:AF:28:DE:29:53:BE:24:D7:1D:C7:91`，文件 SHA-256 `4E88F880D60EB8888CA401D908F026882A4ACD0573D851A4DDB975CFA3BADF68`。 |
| CI / GitHub Release APK | `Eta-v3.0.0.znmlr.1-release.apk`，大小 `6,201,548` bytes，APK Signature Scheme v2、同一证书，SHA-256 `4CD22065D902637466E66DCFDB110E25EFF59884782CF59F036C3CE8D2A57BE3`。 |
...
- 用户已手动覆盖安装 `v3.0.0.znmlr.1` 并反馈无问题；这不替代真实 Codex 账号路径的专项人工验收。
